defmodule Snow.Almanac.RangeSet do
  ...
  Subtract second set from first set.
    ...
    iex> subtract([], [1..1])
    []
    iex> subtract([1..3], [2..2])
    [1..1, 3..3]
  """

  def subtract(minuend, subtrahend) do
    shrink_to_avoid(subtrahend, minuend)
  end
  ...
  @doc """
  Determines whether second argument is a subset of first argument.
  """
